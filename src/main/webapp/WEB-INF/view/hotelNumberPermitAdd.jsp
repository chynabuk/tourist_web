...
<br>
<br>
<form:form action="save" modelAttribute="hotelNumberPermitAdd">
    Hotel Number Permit Code <form:input path="hotelNumberPermitCode"/>
    <br><br>
    Hotel Numbers: <br>
    Room Number     Hotel Name <br>
    <c:forEach var="hn" items="${hotelNumbers}">
        <p>${hn.hotelNumberCode}. ${hn.hotel.name}</p>
    </c:forEach> <br>
